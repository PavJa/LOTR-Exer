...
df_Books_NL = df_Books.drop(['Image-URL-S', 'Image-URL-M','Image-URL-L'], axis=1) # drop pictures
...
sns.countplot(x=df_NoZero_ranking['Book-Rating'], ax=axes[1]).set(title = 'Rating distribution')


plt.figure()
sns.histplot(x=df_BooksUsersRate['Age'],binrange=(10,80), binwidth=1).set(title = 'Age distribution')
